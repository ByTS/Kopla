...
<ul ng-show="y.stationShortCode=='TKL'" ng-controller="yhteydet">
	<li ng-repeat="x in tkl | orderBy:'scheduledTime' | filter:{'cancelled':false}: true" ng-init="x.scheduledTime = (x.timeTableRows | filter:{stationShortCode:'TKL', 'type':'DEPARTURE'})[0].scheduledTime">
